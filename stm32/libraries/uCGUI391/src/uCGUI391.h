#ifndef  __MW_UCGUI_H__
#define  __MW_UCGUI_H__
...
//		void  SetScreenSizeX(int xSize){GUI_SetScreenSizeX(xSize);};
...
*/
		...
		U8        GetFillStyle   (void){return GUI_GetFillStyle();};
//		unsigned  GetPixelIndex  (int x,int y){return GUI_GetPixelIndex  (x,y);};
		...
		U8        SetFillStyle (U8 Style){return GUI_SetFillStyle(Style);};
