...
#include "inc/LCD_Private.h"      /* private modul definitions & config */
#include "inc/GUI_Private.h"
#include "inc/GUIDebug.h"
#include <BSP_TFTLCD.h>
#include "bsp.h"
/*
port use:
LCD_ReadPixel(xPhys, yPhys);
LCD_WritePixel(xPhys, yPhys);
*/
...
**********************************************************************
*/
//extern LCD_DrvTypeDef TFTLCD_DRV;
...
LCD_DrvTypeDef*  pTFTLCD = &TFTLCD_DRV;
/*********************************************************************
*
*       Draw Bitmap 1 BPP
*/
...
void LCD_L0_SetPixelIndex(int x, int y, int PixelIndex) {
  ...
  {
//    lcddev.TextColor = PixelIndex;
	pTFTLCD->WritePixel(xPhys, yPhys,PixelIndex);
//  	LCDX->LCD_REG = R200;
// 	LCDX->LCD_RAM = yPhys;	 
//  	LCDX->LCD_REG = R201;
...
unsigned int LCD_L0_GetPixelIndex(int x, int y) {
 ...
 // {
   // PixelIndex = TFT_ReadPixel(xPhys, yPhys);/* ... */
 // }
//  return LCD_ReadPixel(xPhys, yPhys);
return pTFTLCD->ReadPixel(xPhys, yPhys);
}
...
void LCD_L0_FillRect(int x0, int y0, int x1, int y1) {
 ...
 // }
  pTFTLCD->Fill(x0,y0,x1,y1,LCD_COLORINDEX);
}
